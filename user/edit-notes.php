                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-light rounded h-100 p-4">
                            <h6 class="mb-4">Update Records</h6>
                            <form method="post">
                                <?php
                                $eid=$_GET['editid'];
